<nav id="sidebarMenu" class="sidebar d-md-block bg-primary text-white collapse" data-simplebar>
    <div class="sidebar-inner pt-3">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item {{ Request::segment(2) == 'warrantys' ? 'active' : '' }}"><a href="{{ route('admin.warrantys.index') }}" class="nav-link"><span class="sidebar-icon"><span class="fas fa-box"></span></span> <span>{{ __('messages.warrantys') }}</span></a></li>
