    <form role="form" action="{{ $customer->exists
        ...
        <div class="row p-3">
            ...
            <div class="col-sm-6">
                <div class="mb-2">
                    <label for="document_number">{{ @trans('messages.document_number') }}</label>
            ...
            <div class="col-sm-6">
                <div class="mb-2">
                    <label for="mobile_phone_number">{{ @trans('messages.mobile_phone_number') }}</label>
            ...
            <div class="col-sm-6">
                <div class="mb-2">
                    <label for="street_number">{{ @trans('messages.street_number') }}</label>
            ...
            <div class="col-sm-6">
                <div class="mb-2">
                    <label for="street_name">{{ @trans('messages.street_name') }}</label>
            ...
            <div class="col-sm-6">
                <div class="mb-2">
                    <label for="neighborhood">{{ @trans('messages.neighborhood') }}</label>
            ...
            <div class="col-sm-6">
                <div class="mb-2">
                    <label for="complement">{{ @trans('messages.complement') }}</label>
